...
3. Следуйте командам главного меню.
   ...
   ![](https://img.shields.io/badge/ВНИМАНИЕ!-FF0000) ***При некорректном (принудительном) завершении работы программы текущее состояние списка контактов сохранено не будет.***  ![](https://img.shields.io/badge/ВНИМАНИЕ!-FF0000)  
